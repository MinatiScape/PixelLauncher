...
.method public static e(Landroid/widget/TextView;)LK/g;
    .locals 4
    ...
    invoke-direct {v1, v2}, LK/f;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v1, v2}, LK/f;->b(I)LK/f;
    ...
    invoke-virtual {v1, v2}, LK/f;->c(I)LK/f;
    ...
    .line 7
    invoke-static {p0}, LQ/p;->d(Landroid/widget/TextView;)Landroid/text/TextDirectionHeuristic;

    move-result-object p0

    invoke-virtual {v1, p0}, LK/f;->d(Landroid/text/TextDirectionHeuristic;)LK/f;

    .line 8
    :cond_2
    invoke-virtual {v1}, LK/f;->a()LK/g;
...
.method public static f(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {p0, p1}, LQ/u;->f(Landroid/content/res/ColorStateList;)V
...
.method public static g(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, LQ/u;->b(Landroid/graphics/PorterDuff$Mode;)V
...
.method public static l(Landroid/widget/TextView;LK/h;)V
    .locals 2
    ...
    .line 2
    invoke-virtual {p1}, LK/h;->b()Landroid/text/PrecomputedText;
    ...
    .line 3
    :cond_0
    invoke-static {p0}, LQ/p;->e(Landroid/widget/TextView;)LK/g;

    move-result-object v0

    .line 4
    invoke-virtual {p1}, LK/h;->a()LK/g;

    move-result-object v1

    invoke-virtual {v0, v1}, LK/g;->a(LK/g;)Z
...
.method public static n(Landroid/widget/TextView;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    invoke-direct {v0, p1, p0}, LQ/o;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
